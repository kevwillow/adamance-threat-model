...
| Document | Covers |
| --- | --- |
| [THREAT_MODEL.md](THREAT_MODEL.md) | The control plane. Identity, enrollment, policy distribution, lateral movement, and the operators themselves. |
| [THREAT_MODEL_agent_accounts.md](THREAT_MODEL_agent_accounts.md) | Accounts held by AI agents. Written assuming the agent can be talked into anything. |
| [THREAT_MODEL_installer.md](THREAT_MODEL_installer.md) | The installer and the supply chain behind it, including the part nobody can engineer away. |
| [THREAT_MODEL_audit_anchoring.md](THREAT_MODEL_audit_anchoring.md) | The audit chain and the copy that leaves the box. |
| [THREAT_MODEL_session_recording.md](THREAT_MODEL_session_recording.md) | Recording privileged sessions, and the one deliberate exception. |
| [THREAT_MODEL_samba_ad_dc.md](THREAT_MODEL_samba_ad_dc.md) | The optional module that makes adamance the domain itself. |
| [THREAT_MODEL_network_modules.md](THREAT_MODEL_network_modules.md) | VPN, RADIUS and DNS. The modules that authenticate things adamance does not manage. |
| [THREAT_MODEL_ad_integration.md](THREAT_MODEL_ad_integration.md) | Keeping the Active Directory you already run. |
